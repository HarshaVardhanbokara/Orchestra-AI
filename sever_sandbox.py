...
async def chat_endpoint(
    ...
    try:
        ...
        # 1. Filter out EVERYTHING except messages written by the AI
        ai_messages = []
        ...
        if ai_messages:
            last_ai_msg = ai_messages[-1] # Grab the very last AI message
            
            # Get the content
            raw_content = last_ai_msg.get("content", "") if isinstance(last_ai_msg, dict) else getattr(last_ai_msg, "content", "")
